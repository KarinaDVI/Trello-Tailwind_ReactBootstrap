...
export default function SwitchColorMode() {
  ...
  return (
    <div className="flex items-center text-gray-200 text-sm">
      <p className={`pr-2 ${darkMode?'text-gray-100':'text-gray-700'}`}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-mask" viewBox="0 0 16 16">
